...
import image1 from '../videos/korea6.jpg';
import image2 from '../videos/korea7.jpg';
import image3 from '../videos/korea8.jpg';
import image4 from '../videos/korea9.jpg';

function Korea() {
    return (
        <div>
            <div data-aos='fade-up' className='destination1'>
                <h1 className='page12'>South Korea </h1>
